                                ...
                                <table class="table">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th class="text-center" scope="col">Tahun Terbit Buku</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{$b->kode_kategori}}</td>
                                            <td class="text-center">{{$b->kode_penerbit}}</td>
                                            <td class="text-center">{{$b->judul_buku}}</td>
                                            <td class="text-center">{{$b->jumlah_buku}}</td>
                                            <td class="text-center">{{$b->pengarang_buku}}</td>
                                            <td class="text-center">{{$b->tahun_terbit_buku}}</td>
                                            @endforeach
                                            <!-- <td>
